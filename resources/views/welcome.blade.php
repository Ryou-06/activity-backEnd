...
<body>
    ...
    <section class="features">
        ...
        <div class="feature-grid">
            <div class="feature-card"><div class="icon">📋</div><h3>Student Records</h3><p>Add, view, update, and delete student enrollment information with ease.</p></div>
            <div class="feature-card"><div class="icon">🔒</div><h3>Secure Access</h3><p>Role-based authentication ensures only authorized staff can manage records.</p></div>
            <div class="feature-card"><div class="icon">📊</div><h3>Dashboard Overview</h3><p>Get a quick summary of enrolled students by course, year, and block.</p></div>
            <div class="feature-card"><div class="icon">🎓</div><h3>Gordon College</h3><p>Built for BSCS, BSIT, BSCS-EMC DAT, and BSEMC-GD programs.</p></div>
        </div>
    </section>
    <footer class="footer">
